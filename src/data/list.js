  ...
  "exercise": [
    {
      ...
      "type": 1,
      "title": "SayHello",
      "desc": "Input data that is passed into the component can be accessed by render() via this.props.",
      "url": "/SayHello"
    },
    {
      "id": 10002,
      "type": 1,
      "title": "SecondsTimer",
      "desc": "Use of timer. Do the corresponding things in different lifecycle.",
      "url": "/SecondsTimer"
    },
    {
      "id": 10003,
      "type": 1,
      "title": "Countdown",
      "desc": "A simple countdown just in one day, set a end-time from 'endTo' attribute.",
      "url": "/UseCountdown"
    },
    {
      "id": 10004,
  ...
  "production": [
    {
      ...
      "type": 2,
      "title": "Iconfont",
      "desc": "The method for importing Iconfont, coding method and use of Icon component.",
      "url": "/UseIcon"
    },
    {
      "id": 20002,
